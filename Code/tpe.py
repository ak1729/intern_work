...
optimal_x = best['x']
print(f'Best hyperparameters: {optimal_x}')
...
tot=end-start
localProcTpe = localProcrustes(X, predicted_X)
mse = mean_squared_error(predicted_X, X)

print("Local Proscrustes Measure: ", localProcTpe)
